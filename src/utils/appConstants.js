export const cities = {
  ...
  Chandigarh: [{ id: "43", city: "Chandigarh" }],
  Odisha: [
  ...
  "Andaman and Nicobar Islands": [{ id: "333", city: "Port Blair" }],
  "Arunachal Pradesh": [
    { id: "788", city: "Naharlagun" },
    { id: "1121", city: "Pasighat" },
  ],
  "Dadra and Nagar Haveli": [{ id: "1128", city: "Silvassa" }],
};
